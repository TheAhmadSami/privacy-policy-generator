    ...
    <DocumentMeta >
      <div id="privacy_policy">
        ...
        <section>
          ...
          <div className="content">
            <ul>
              ...
              <li>
                <span>Country:</span> where <a href={appWebsite}>{appName}</a>{" "}
                or the owners/founders of <a href={appWebsite}>{appName}</a> are
              ...
              <li>
                ...
                <a href={appWebsite}>{appName}</a> Service to manage the
              ...
              <li>
                <span>IP address:</span> Every device connected to the Internet
        ...
        <section>
          ...
          <div className="content">
            <p>
              The laws of {companyCountry}, excluding its conflicts of law
              rules, shall govern this Agreement and your use of our service.
