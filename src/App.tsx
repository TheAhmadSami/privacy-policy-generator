...
const App = () => {
    ...
    return (
      <>
        ...
        <p>
          ...
          person. Personal data extends beyond a person’s name or physical
  ...
  return (
    <div id="privacy_policy">
      <h1>
        Privacy Policy <span className="desc">Updated at {publishDate}</span>
      </h1>

      <p>
        This policy describes the information we process to support{" "}
        <a href={appWebsite}>{appName}</a> and other products and features
        offered by <a href={companyWebsite}>{companyName}</a>.
      </p>

      <p>
        This Privacy Policy applies to our application named{" "}
        <a href={appWebsite}>{appName}</a> , and its associated subdomains
      ...
      <section>
        <h2>
          ...
          <span className="desc">For this Privacy Policy:</span>
        </h2>
        ...
        <div className="content">
          <ul>
            ...
            <li>
              ...
              “us,” or “our,” it refers to{" "}
              <a href={companyWebsite}>{companyName}</a>,{" "}
              <a href={companyAddressLink}>{companyAddress}</a> that is
              responsible for your information under this Privacy Policy.
            </li>

            <li>
              <span>Country:</span> where <a href={appWebsite}>{appName}</a> or
              the owners/founders of <a href={appWebsite}>{appName}</a> are
              based, in this case is <a>{companyCountry}</a>.
            </li>

            <li>
              <span>Customer:</span> refers to the company, organization or
              person that signs up to use the <a href={appWebsite}>{appName}</a>{" "}
            ...
            <li>
              ...
              visit <a href={appWebsite}>{appName}</a> and use the services.
            </li>
            ...
            <li>
              ...
              employed by <a href={appWebsite}>{appName}</a> or are under
            ...
            <li>
              ...
              <a href={appWebsite}>{appName}</a> as described in the relative
            ...
            <li>
              <span>Website:</span> <a href={appWebsite}>{appName}</a>’s site,
              which can be accessed via this URL:{" "}
              <a href={appWebsite}>{appWebsite}</a>
            </li>

            <li>
              <span>You:</span> a person or entity that is registered with{" "}
              <a href={appWebsite}>{appName}</a> to use the Services.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="content">
          <p>
            We are incorporated in {companyCountry}. Information collected via
      ...
      <section>
        ...
        <div className="content">
          <p>
            The laws of {companyCountry}, excluding its conflicts of law rules,
            shall govern this Agreement and your use of our service. Your use of
      ...
      <section>
        ...
        <div className="content">
          <p>
            ...
            {appName}. We are not responsible for the content, accuracy or
      ...
      <section>
        ...
        <div className="content">
          ...
          <ul className="contact-info-list">
            {emailStatus ? (
              <li>
                Via Email: <a href={"mailto:" + companyEmail}>{companyEmail}</a>
              </li>
            ) : (
              ""
            )}
            {phoneStatus ? (
              <li>
                Via Phone On the following numbers: <br />
